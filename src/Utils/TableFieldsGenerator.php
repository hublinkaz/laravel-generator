...
namespace Hublinkaz\Generator\Utils;

use DB;
use Doctrine\DBAL\Schema\AbstractSchemaManager;
use Doctrine\DBAL\Schema\Column;
use Illuminate\Support\Str;
use Hublinkaz\Generator\Common\GeneratorField;
use Hublinkaz\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName, $ignoredFields, $connection = '')
    {
        ...
        $mappings = config('hublinkaz.laravel_generator.from_table.doctrine_mappings', []);
        ...
        $this->defaultSearchable = config('hublinkaz.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('hublinkaz.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('hublinkaz.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('hublinkaz.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('hublinkaz.laravel_generator.timestamps.deleted_at', 'deleted_at');
