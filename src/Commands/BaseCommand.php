...
namespace Hublinkaz\Generator\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Str;
use Hublinkaz\Generator\Common\CommandData;
use Hublinkaz\Generator\Generators\API\APIControllerGenerator;
use Hublinkaz\Generator\Generators\API\APIRequestGenerator;
use Hublinkaz\Generator\Generators\API\APIResourceGenerator;
use Hublinkaz\Generator\Generators\API\APIRoutesGenerator;
use Hublinkaz\Generator\Generators\API\APITestGenerator;
use Hublinkaz\Generator\Generators\FactoryGenerator;
use Hublinkaz\Generator\Generators\MigrationGenerator;
use Hublinkaz\Generator\Generators\ModelGenerator;
use Hublinkaz\Generator\Generators\RepositoryGenerator;
use Hublinkaz\Generator\Generators\RepositoryTestGenerator;
use Hublinkaz\Generator\Generators\Scaffold\ControllerGenerator;
use Hublinkaz\Generator\Generators\Scaffold\JQueryDatatableAssetsGenerator;
use Hublinkaz\Generator\Generators\Scaffold\MenuGenerator;
use Hublinkaz\Generator\Generators\Scaffold\RequestGenerator;
use Hublinkaz\Generator\Generators\Scaffold\RoutesGenerator;
use Hublinkaz\Generator\Generators\Scaffold\ViewGenerator;
use Hublinkaz\Generator\Generators\SeederGenerator;
...
class BaseCommand extends Command
{
    ...
    {
        $migrationPath = config('hublinkaz.laravel_generator.path.migration', database_path('migrations/'));
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('hublinkaz.laravel_generator.path.schema_files', resource_path('model_schemas/'));
    ...
    private function saveLocaleFile()
    {
        ...
        $path = config('hublinkaz.laravel_generator.path.models_locale_files', base_path('resources/lang/en/models/'));
