...
class LayoutPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'hublinkaz.publish:layout';
    ...
    private function copyView()
    {
        ...
        $templateType = config('hublinkaz.laravel_generator.templates', 'adminlte-templates');
    ...
    private function fillTemplate($templateData)
    {
        $templateData = str_replace(
            ...
            config('hublinkaz.laravel_generator.namespace.controller'),
            $templateData
        );

        $templateData = str_replace(
            '$NAMESPACE_REQUEST$',
            config('hublinkaz.laravel_generator.namespace.request'),
            $templateData
        );
