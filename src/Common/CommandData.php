...
use Hublinkaz\Generator\Events\GeneratorFileCreated;
use Hublinkaz\Generator\Events\GeneratorFileCreating;
use Hublinkaz\Generator\Events\GeneratorFileDeleted;
use Hublinkaz\Generator\Events\GeneratorFileDeleting;
use Hublinkaz\Generator\Utils\FileUtil;
use Hublinkaz\Generator\Utils\GeneratorFieldsInputUtil;
use Hublinkaz\Generator\Utils\TableFieldsGenerator;
            ...
            if ($this->getOption('fieldsFile')) {
                ...
                if (file_exists($fieldsFileValue)) {
                    ...
                    $schemaFileDirector = config(
                        'hublinkaz.laravel_generator.path.schema_files',
