...
class RepositoryGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        ...
        $update_data = ['$data = ' . $this->commandData->modelName . '::where("id",$id)->firstOrFail();'];
        $update_data[] = '$fields=[];';

        $delete_data = ['$data = ' . $this->commandData->modelName . '::where("id",$id)->firstOrFail();'];
