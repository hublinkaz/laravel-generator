...
namespace Hublinkaz\Generator\Generators\Scaffold;

use Illuminate\Support\Arr;
use Illuminate\Support\Str;
use Hublinkaz\Generator\Common\CommandData;
use Hublinkaz\Generator\Generators\BaseGenerator;
use Hublinkaz\Generator\Generators\ViewServiceProviderGenerator;
use Hublinkaz\Generator\Utils\FileUtil;
use Hublinkaz\Generator\Utils\HTMLFieldGenerator;
    ...
    private function generateTableHeaderFields()
    {
        ...
        foreach ($this->commandData->fields as $field) {
            ...
            if ($localized) {
                 ...
                 *
                 * @see issue https://github.com/HublinkazLabs/laravel-generator/issues/887
                 */
