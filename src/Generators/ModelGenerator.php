...
class ModelGenerator extends BaseGenerator
{
    ...
    private function fillSoftDeletes($templateData)
    {
        if (!$this->commandData->getOption('softDelete')) {
            ...
            $deletedAtTimestamp = config('hublinkaz.laravel_generator.timestamps.deleted_at', 'deleted_at');
            $templateData = str_replace(
                '$SOFT_DELETE_DATES$',
    ...
    {
        $dont_require_fields = config('hublinkaz.laravel_generator.options.hidden_fields', [])
                + config('hublinkaz.laravel_generator.options.excluded_fields', $this->excluded_fields);
